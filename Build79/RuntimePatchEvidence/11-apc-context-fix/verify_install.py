...
bundle=stage[0];base=ROOT/'outputs/ipad-installers/Madeira-iPad-APC-Context-v1-Test.ipa'
...
target=ROOT/'outputs/ipad-installers/Madeira-iPad-APC-Context-v1-Signed.ipa'
