...
bundle=stage[0];base=ROOT/'outputs/ipad-installers/Madeira-iPad-SRW-Guard-v1-Test.ipa'
...
target=ROOT/'outputs/ipad-installers/Madeira-iPad-SRW-Guard-v1-Signed.ipa'
...
report={'installed':True,'installer_exit_code':0,'installation_complete_log_confirmed':True,
 ...
 'cli_output_copy_not_used_as_signed_archive':True,'device_test_pending':True,'anonymous_srw_reap_disabled':True,'physical_lock_fix_validated':False}
